...
import { Aggregate, CellType, Clipboard, ColumnChooser, ColumnMenu, CommandColumn, ContextMenu, DetailRow, Edit, ExcelExport, Filter, Freeze, Grid, InfiniteScroll, InterSectionObserver, Logger, Page, PdfExport, Print, RenderType, Reorder, Resize, RowDD, RowDropSettings, RowRenderer, Scroll, Sort, Toolbar, VirtualContentRenderer, VirtualRowModelGenerator, VirtualScroll, appendChildren, calculateAggregate, detailLists, extend as extend$1, getActualProperties, getObject, getUid, iterateArrayOrObject, parentsUntil, resetRowIndex, templateCompiler } from '@syncfusion/ej2-grids';
...
class Aggregate$1 {
    ...
    calculateSummaryValue(summaryQuery, filteredData, isSort) {
        ...
        const columnLength = Object.keys(this.parent.columns).length;
        ...
        if (this.parent.aggregates.filter((x) => x.showChildSummary).length) {
                ...
                if (childRecordsLength) {
                    for (let summaryRowIndex = 1, len = summaryLength; summaryRowIndex <= len; summaryRowIndex++) {
                        ...
                        for (let columnIndex = 0, len = columnLength; columnIndex < len; columnIndex++) {
                            const field = isNullOrUndefined(getObject('field', this.parent.columns[columnIndex])) ?
            ...
            for (let columnIndex = 0, length = columnLength; columnIndex < length; columnIndex++) {
                const fields = isNullOrUndefined(getObject('field', this.parent.columns[columnIndex])) ?
                    this.parent.columns[columnIndex] : getObject('field', this.parent.columns[columnIndex]);
                items[fields] = null;
            }
